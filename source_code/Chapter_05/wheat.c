/* Ch05_05_wheat.c -- 指数增长 */

/*
    一位强大的统治者想奖励做出突出贡献的学者。
    他问这位学者想要什么，学者指着棋盘说，在第 1 个方格放 1 粒小麦、
    在第 2 个方格放 2 粒小麦、第 3 个方格放 4 粒小麦、第 4 个方格放 8 粒小麦，以此类推。
    这位统治者不熟悉数学，很惊讶学者竟然提出如此谦虚的要求。因为他原本准备奖励给学者一大笔财产。
    如果程序清单 5.5 运行的结果正确，这显然跟统治者开了一个玩笑。

    程序计算除每个方格应放多少粒小麦，并计算了总数。
    该程序以谷物粒为单位，把计算的小麦总数与粗略估计的世界小麦年产量进行了比较。
*/
